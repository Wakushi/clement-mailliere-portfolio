export default function Footer() {
  return (
    <footer className="flex items-center absolute bottom-0 opacity-0 p-2 w-full max-h-[100px] md:p-[4rem] bg-gradient-to-b from-transparent to-black fade-in-bottom-4">
