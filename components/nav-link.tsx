...
export default function NavLink({ href, src, title }: NavLinkProps) {
  return (
    <li className="nav-link bg-black custom-box-shadow relative h-[100px] w-[400px] md:h-[700px] md:w-[100px] fade-in-bottom-1 lg:h-[800px] lg:w-[100px] opacity-0 transition-all duration-500 ease-in-out overflow-hidden filter grayscale hover:h-[300px] hover:opacity-100 hover:grayscale-0  md:hover:h-[700px] lg:hover:h-[800px] md:hover:w-[700px]">
      <Image
        className="scale-105"
        unoptimized={
